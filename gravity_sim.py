...
class Partical(object):
    """
    Discription: Partical class (fill in details)
    Class Var: dt, time step
    Attributes:
    position, Array with x,y,z cartesian coordinates.
    velocity, Array with x,y,z dierction
    acceleration, Array with x,y,z direction
    mass, scalor value
    """
    dt = 0.3
